...
namespace FaceSplitScripter
{
    internal static class Constants
    {
        ...
        public const string SKILL_ORB_VARIABLE_NAME = "faceSplitSkillOrb";
        public const string MCD_VARIABLE_NAME = "faceSplitMcd";
        public const string MISSING_ITEMS_LIST_NAME = "faceSplitMissingList";

        public const string CHROMATIC_CORE_VARIABLE_NAME = "faceSplitChromaticCore";
        public const string CHROMATIC_DISTILL_VARIABLE_NAME = "faceSplitChromaticDistill";
        ...
        public const string CHROMATIC_CORE_ITEM_TYPE = "4025";
        public const string CHROMATIC_DISTILL_ITEM_TYPE = "4026";
        ...
        public const string SKILL_ORB_ITEM_NAME = "void orb";
        public const string MCD_ITEM_NAME = "book of truth";

        public const string CHROMATIC_CORE_ITEM_NAME = "chroma core";
        public const string CHROMATIC_DISTILL_ITEM_NAME = "chroma distil";
    }
    ...
    {
        public string ItemType => Constants.MCD_ITEM_TYPE;
        public string ItemName => Constants.MCD_ITEM_NAME;
        public string VariableName => Constants.MCD_VARIABLE_NAME;
        public string Hue => "0";
    ...
    {
        public string ItemType => Constants.SKILL_ORB_ITEM_TYPE;
        public string ItemName => Constants.SKILL_ORB_ITEM_NAME;
        public string VariableName => Constants.SKILL_ORB_VARIABLE_NAME;
    ...
    {
        public string ItemType => Constants.CHROMATIC_CORE_ITEM_TYPE;
        public string ItemName => Constants.CHROMATIC_CORE_ITEM_NAME;
        public string VariableName => Constants.CHROMATIC_CORE_VARIABLE_NAME;
        public string Hue => "0";
    ...
    {
        public string ItemType => Constants.CHROMATIC_DISTILL_ITEM_TYPE;
        public string ItemName => Constants.CHROMATIC_DISTILL_ITEM_NAME;
        public string VariableName => Constants.CHROMATIC_DISTILL_VARIABLE_NAME;
        public string Hue => "0";
