...
{
    internal class ResourceMapFishingLootItem : ILootItem
    {
        public LootType LootType { get { return LootType.ResourceMapFishing; } }
        public ResourceType ResourceType { get; private set; }
        public int TomePage { get { return 1; } }
        public string Description { get; private set; }

        public ResourceMapFishingLootItem(string description, ResourceType resourceType)
        {
