...
{
    internal class ResourceMapSkinningLootItem : ILootItem
    {
        public LootType LootType { get { return LootType.ResourceMapSkinning; } }
        public ResourceType ResourceType { get; private set; }
        public int TomePage { get { return 1; } }
        public string Description { get; private set; }

        public ResourceMapSkinningLootItem(string description, ResourceType resourceType)
        {
