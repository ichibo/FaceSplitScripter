...
{
    internal class ResourceMapMiningLootItem : ILootItem
    {
        public LootType LootType { get { return LootType.ResourceMapMining; } }
        public ResourceType ResourceType { get; private set; }
        public int TomePage { get { return 1; } }
        public string Description { get; private set; }

        public ResourceMapMiningLootItem(string description, ResourceType resourceType)
        {
